...
// General
$moxieManagerConfig['general.license'] = 'N42U-2KW6-Y5OF-ELWR-IU2Q-5DOY-IUEX-CACF';
...
$moxieManagerConfig['filesystem.rootpath'] = '../../../media/ckediter/';
...
$moxieManagerConfig['basicauthenticator.users'] = array(
    array("username" => "apurwa", "password" => "peters", "groups" => array("administrator"))
);

// GoogleDrive
$moxieManagerConfig['googledrive.client_id'] = '175565194484-812obbgkc29fbjl6v2pec01sqvihka0q.apps.googleusercontent.com';


// DropBox
$moxieManagerConfig['dropbox.app_id'] = 'x8flhasbhx44pfr';
