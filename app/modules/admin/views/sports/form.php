    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                $edit_id = 0;
                $activeClass = '';
                if (isset($aContentInfo->sport_id)) {
                    $edit_id = $aContentInfo->sport_id;
                    $activeClass = 'hide';
                }
                $attribute = array("id" => "form1", "method" => "post", "class" => "form-horizontal");
                echo form_open_multipart('', $attribute);
                echo form_hidden('sport_id', $edit_id);
                ?>
                <fieldset>	
                    ...
                    <div class="form-group">
                        ...
                        <?php if (isset($aContentInfo->attachment)) { ?> 
                            <div class="col-md-3 text-left">
                                ...
                                $attachment = $aContentInfo->attachment;
                                ?>
                                <a href="<?php echo media_download_url($attachment, 'sports'); ?>"><i class="fa fa-download fa-2x"></i>Download</a>                                                                
                            </div>			
                        <?php } ?>
                    </div>
