                            ...
                            if (!empty($aGrid->rows)  && is_array($aGrid->rows)) {
                                ...
                                foreach ($aGrid->rows as $row) {
                                    ...
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td><?php
                                            show_image($row->image, array("width" => "100", "height" => "50"), 'client');
                                            ?></td>                                        
                                        <td class="text-center">
                                            <a class="btn btn-xs btn-primary" href="<?php echo $moduleUrl; ?>add/<?php echo $row->id ?>">Edit</a>
                                            <a onclick="return confirm('Are you sure want to delete this client #<?php echo $i; ?>')" class="btn btn-xs btn-danger" href="<?php echo $moduleUrl; ?>delete/<?php echo $row->id ?>">Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
