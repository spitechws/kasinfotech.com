                                ...
                                foreach ($aGrid->rows as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="action">
                                            ...
                                            &nbsp;
                                            <a onclick="return confirm('Are you sure want to delete testimonial #<?php echo $i;?>')" class="delete" href="<?php echo $moduleUrl; ?>delete/<?php echo $row->testimonial_id ?>"><i class="glyphicon glyphicon-remove" title="<?php echo lang('Delete') ?>"><?php echo lang('Delete') ?></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
