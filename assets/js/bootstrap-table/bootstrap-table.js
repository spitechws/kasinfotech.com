...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-default" type="button" name="toggle" title="%s">',     this.options.formatToggle()),
        ...
        if (this.options.showAddButton) {           
           var url="window.location='"+this.options.addUrl+"'";
           html.push(sprintf('<button class="btn btn-primary" onclick="'+url+'" title="Add New"><i class="glyphicon glyphicon-plus"></i></button>'));
        }       
        if (this.options.showDeleteButton) {            
            html.push(sprintf('<button class="btn btn-danger" onclick="deleteRecord()" title="Delete Selected Records"><i class="glyphicon glyphicon-remove"></i></button>'));
        }
        if (this.options.showExportButton) {
             var url="window.location='"+this.options.exportUrl+"'";
            html.push(sprintf('<button class="btn btn-primary" onclick="'+url+'" title="Export To Excel"><i class="glyphicon glyphicon-export"></i></button>'));
        }
        ...
        if (this.options.search) {
            ...
            html.push(
                '<div class="pull-right search">',
                    sprintf('<input class="form-control" id="tblSearch" type="text" placeholder="%s">',
