                ...
                <div class="row g-4 gy-lg-0 align-items-md-center">
                    <div class="mx-auto col-3 col-sm-2 col-lg-1">
                        <a href="https://www.greatplacetowork.in/great/company/bacancy-software-llp" target="_blank">
                            <img src="fonts/gpw.svg" alt="Great Place to Work" title="Great Place to Work" class="footer-gptw">
                        </a>
                    </div>
...
<script src="assets/js/jquery.min.js" type="591e8dac46237a91d428b1a4-text/javascript"></script>
<script src="assets/js/bootstrap.bundle.min.js%2Cqv-2.pagespeed.jm.wJ8zk3E_nH.js" type="591e8dac46237a91d428b1a4-text/javascript"></script>
<script src="assets/js/owl.carousel.min.js" crossorigin="anonymous" type="591e8dac46237a91d428b1a4-text/javascript"></script>
<script src="assets/js/main.js" type="591e8dac46237a91d428b1a4-text/javascript"></script>
<script defer type="591e8dac46237a91d428b1a4-text/javascript">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KMHRSL" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>

<script src="assets/js/scroll-library.js%2Cqv-13%2Bjquery.validate.min.js%2Cqv-14.pagespeed.jc.zjXcKgOGgU.js" type="591e8dac46237a91d428b1a4-text/javascript"></script>
<script type="591e8dac46237a91d428b1a4-text/javascript">
...
<script type="591e8dac46237a91d428b1a4-text/javascript">
    ...
    $(document).ready(function() {
        var user_visit = "https://www.bacancytechnology.com/";
        ...
        $("#resumeForm").validate({
            ...
            messages: {
                ...
                notice: "Please enter Notice Period",
                linkedin: "Please enter LinkedIn Profile",
                file: "Please upload resume"
            },
            errorPlacement: function(error, element) {
                $('#resumeForm').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                $('#resumeForm button').prop('disabled', true);
                $('#resumeForm button span').html('Please Wait');
                $('#resumeForm button span').addClass('pleasewait');
                var fileval = document.getElementById('file').files[0];
                var formData = new FormData(form);
                formData.append('type', 'resume');
                formData.append('page', window.location.href);
                formData.append('leadingPage', user_visit);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 'Success') {
                            $(form).trigger("reset");
                            $(form).before('<div id="notify" class="alert alert-success" role="alert">Success</div>');
                            window.location.href = "/thank-you.php";
                        } else if (data == 'Upload failed') {
                            $(form).before('<div id="notify" class="alert alert-danger" role="alert">File Upload Failed</div>');
                        } else if (data == 'file information not match') {
                            $(form).before('<div id="notify" class="alert alert-danger" role="alert">Only formats are allowed pdf, doc and docx and Allow less than 5MB</div>');
                        } else {
                            $(form).before('<div id="notify" class="alert alert-danger" role="alert">Failed</div>');
                        }
                        $("#notify").delay(3000).queue(function() {
                            $(this).remove();
                            $('#contactForm button').prop('disabled', false);
                            $('#contactForm button span').html('Inquire Now');
                            $('#contactForm button span').removeClass('pleasewait');
                        });
                    }
                });
            }
        ...
        $("#contactForm").validate({
            ...
            errorPlacement: function(error, element) {
                $('#contactForm').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                $('#contactForm button').prop('disabled', true);
                $('#contactForm button span').html('Please Wait');
                $('#contactForm button span').addClass('pleasewait');
                $.ajax({
                    type: "POST",
                    url: 'https://www.bacancytechnology.com/sf-mail-data',
                    data: $(form).serialize() + '&type=contactUs&page=' + window.location.href + '&leadingPage=' + user_visit,
                    success: function(data) {
                        if (data == 'Success') {
                            $(form).trigger("reset");
                            $(form).before('<div id="notify" class="alert alert-success" role="alert">Success</div>');
        ...
        $("#contactFormtest").validate({
            ...
            errorPlacement: function(error, element) {
                $('#contactFormtest').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                $('#contactFormtest button').prop('disabled', true);
                $('#contactFormtest button span').html('Please Wait');
                $('#contactFormtest button span').addClass('pleasewait');
                $.ajax({
                    type: "POST",
                    url: 'https://www.bacancytechnology.com/sf-mail-data',
                    data: $(form).serialize() + '&type=contactUs&page=' + window.location.href + '&leadingPage=' + user_visit,
                    success: function(data) {
                        ...
                        $("#notify").delay(3000).queue(function() {
                            $(this).remove();
                            $('#contactFormtest button').prop('disabled', false);
                            $('#contactFormtest button span').html('Inquire Now');
                            $('#contactFormtest button span').removeClass('pleasewait');
                        });
                    }
                });
            }
        });
        $("#contactFormBanner").validate({
            rules: {
                contactEmail: {
                    required: true,
                    email: true
            ...
            errorPlacement: function(error, element) {
                $('#contactFormBanner').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                $('#contactFormBanner button').prop('disabled', true);
                $('#contactFormBanner button').prop('value', "Please Wait");
                $('#contactfullForm button span').addClass('pleasewait');
                $.ajax({
                    type: "POST",
                    url: 'https://www.bacancytechnology.com/sf-mail-data',
                    data: $(form).serialize() + '&type=contactUs&page=' + window.location.href + '&leadingPage=' + user_visit,
                    success: function(data) {
                        ...
                        $("#notify").delay(3000).queue(function() {
                            $(this).remove();
                            $('#contactFormBanner button').prop('disabled', false);
                            $('#contactFormBanner button span').html('Inquire Now');
                            $('#contactForm button span').removeClass('pleasewait');
                        });
                    }
                });
        ...
        $("#contactfullForm").validate({
            ...
            errorPlacement: function(error, element) {
                $('#contactfullForm').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                $('#contactfullForm button').prop('disabled', true);
                $('#contactfullForm button span').html('Please Wait');
                $('#contactfullForm button span').addClass('pleasewait');
                $.ajax({
                    type: "POST",
                    url: 'https://www.bacancytechnology.com/sf-mail-data',
                    ...
                    success: function(data) {
                        ...
                        $("#notify").delay(3000).queue(function() {
                            $(this).remove();
                            $('#contactForm button').prop('disabled', false);
                            $('#contactfullForm button span').html('Inquire Now');
                            $('#contactfullForm button span').removeClass('pleasewait');
                        });
                    }
                });
            }
        });
        $("#contactfullForm").removeAttr("novalidate");
        ...
        $("#resourceForm").validate({
            ...
            messages: {
                contactEmailR: "Please enter a valid email address",
            },
            errorPlacement: function(error, element) {
                $('#resourceForm').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                $('#resourceForm button').prop('disabled', true);
                $('#resourceForm button span').html('Please Wait');
                $('#resourceForm button span').addClass('pleasewait');
                let resourceLink = "";
                $.ajax({
                    type: "POST",
                    url: 'https://www.bacancytechnology.com/sf-mail-data',
                    cache: false,
                    data: $(form).serialize() + '&type=resourceForm&resourceLink=' + resourceLink + '&page=' + window.location.href + '&leadingPage=' + user_visit,
                    success: function(data) {
                        if (data == 'Success') {
                            $(form).trigger("reset");
                            $(form).before('<div id="notify" class="alert alert-success" role="alert">Success</div>');
                            window.location.href = "/resource-downloaded";
                        } else {
                            $(form).before('<div id="notify" class="alert alert-danger" role="alert">Failed</div>');
                        }
                        $("#notify").delay(3000).queue(function() {
                            ...
                            $('#resourceForm button span').html('Inquire Now');
                            $('#resourceForm button span').removeClass('pleasewait');
                        });
                    }
                });
            }
        });
        $("#emailFormbanner").validate({
            rules: {
                contactEmailHD: {
                    required: true,
                    email: true
            ...
            messages: {
                contactEmailHD: "Please enter a valid email address",
            },
            errorPlacement: function(error, element) {
                $('#emailFormbanner').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                $('#emailFormbanner button').prop('disabled', true);
                $('#emailFormbanner button span').html('Please Wait');
                $('#emailFormbanner button span').addClass('pleasewait');
                var isOrganic = false;
                if ($('#emailFormbanner').hasClass('emailFormbanner_org')) {
                    isOrganic = true;
                }
                $.ajax({
                    type: "POST",
                    url: 'https://www.bacancytechnology.com/sf-mail-data',
                    data: $(form).serialize() + '&type=bannerEmanilForm&page=' + window.location.href + '&leadingPage=' + user_visit + '&isOrganic=' + isOrganic,
                    success: function(data) {
                        if (data == 'Success') {
                            $(form).trigger("reset");
                            $(form).before('');
                            if ($('#emailFormbanner').parent().hasClass('hire-dev-two')) {
                                window.location.href = "/hire-developers-2?only-email";
                            } else if ($('#emailFormbanner').hasClass('emailFormbanner_org')) {
                                window.location.href = "/thank-you";
                            } else {
                                window.location.href = "/hire-developers?only-email";
                            }
                        } else {
                            $(form).before('<div id="notify" class="alert alert-danger" role="alert">Failed</div>');
                        }
                        $("#notify").delay(3000).queue(function() {
                            $(this).remove();
                            $('#contactForm button').prop('disabled', false);
                            $('#emailFormbanner button span').html('Inquire Now');
                            $('#emailFormbanner button span').removeClass('pleasewait');
                        });
                    }
                });
            }
        });
        $("#DeveloperFind").validate({
            rules: {
                devemail: {
                    required: true,
                    email: true
            ...
            messages: {
                devemail: "Please enter a valid email address",
                hireTech: "Please select atleast one skill",
            },
            errorPlacement: function(error, element) {
                $('#DeveloperFind').addClass('attempted-submit');
            },
            submitHandler: function(form) {
                var checkSkills = $('.skillList:checked').length;
                var otherSkills = $('.otherSkills option:selected').length;
                ...
                $.ajax({
                    type: "POST",
                    url: 'https://www.bacancytechnology.com/sf-mail-data',
                    data: $(form).serialize() + '&prevPage=' + prevPage + '&name=' + name + '&type=hireDeveloperEmail&page=' + window.location.href + '&leadingPage=' + user_visit,
                    success: function(data) {
                        console.log(data);
                        if (data == 'Success') {
                            $(form).trigger("reset");
                            $(form).before('');
                            window.location.href = "https://calendly.com/bacancymeeting/30min?email=" + devEmail;
                        } else {
                            $(form).before('<div id="notify" class="alert alert-danger" role="alert">Failed</div>');
                        }
                    }
        ...
        $(document).ready(function() {
            ...
            $("#CareerSubscribeForm").submit(function(e) {
                e.preventDefault();
                var $form = $(this),
                    email = $form.find('input[name="Careeremail"]').val(),
                    url = "https://www.bacancytechnology.com/main-boot-5/form-file/career-subscribe-form";
                if (email != '') {
                    $.post(url, {
                        email: email
                    }, function(data) {
                        if (data) {
                            if (data == "Some fields are missing.") {} else if (data == "Invalid email address.") {
                                $("#careerError").text("Invalid email address");
                                $("#careerError").css("color", "red");
                            } else if (data == "Invalid list ID.") {
                                $("#careerError").text("Your list ID is invalid.");
                                $("#careerError").css("color", "red");
                            } else if (data == "Already subscribed.") {
                                $("#careerError").text("You're already subscribed!");
                                $("#careerError").css("color", "red");
                            } else {
                                $("#careerError").text("You're subscribed!");
                                $("#careerError").css("color", "green");
                            }
                        } else {
                    ...
                    $("#careerError").text("Please enter your email address");
                    $("#careerError").css("color", "red");
                }
            });
            $("#CareerSubscribeForm").keypress(function(e) {
                if (e.keyCode == 13) {
                    e.preventDefault();
                    $(this).submit();
                }
            });
            $("#careerSubmit").click(function(e) {
                e.preventDefault();
                validates();
                $("#CareerSubscribeForm").submit();
            });
        });
    ...
    function setCookieBt() {
        cname = "cookie_accept_bt";
        cvalue = "Yes";
        exdays = 1000;
        var d = new Date();
    ...
    function hideCookieNote() {
        $(".cookie_permission_bt").css('display', 'none');
    }
    setCookieBt();
...
<script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "Bacancy | Agile Organization",
        "image": "https://www.bacancytechnology.com/main/img/bacancy_og.png",
        "url": "https://www.bacancytechnology.com/",
        "telephone": "+917940037674",
        "priceRange": "$18-$49",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "1207 to 1210 Times Square I,Thaltej - Shilaj Rd, opposite Rambag, Thaltej,",
...
<script type="591e8dac46237a91d428b1a4-text/javascript">
    $("[data-video]").click(function() {
        $($(this).attr("data-target")).find(".js-video-src").attr("src", $(this).attr("data-video"));
    });
