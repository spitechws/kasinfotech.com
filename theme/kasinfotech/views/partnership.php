        ...
        <div class="row gy-4 align-items-lg-center">
            <div class="col-lg-6">
                <picture>
                    ...
                    <img
                        data-src="<?php echo asset();?>images/partnership/xside-img-1.jpg,qv-2.pagespeed.ic.fpcL52HaWQ.webp"
                        src="<?php echo asset();?>images/partnership/xside-img-1.jpg,qv-2.pagespeed.ic.fpcL52HaWQ.webp"
                        alt="We take forward plunges of innovation by covering diverse markets and allying with partners for mutual progress."
                        title="We take forward plunges of innovation by covering diverse markets and allying with partners for mutual progress."
                        class="ob-cover"
                        data-pagespeed-url-hash="237270426"
                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);"
                    />
                </picture>
            </div>
