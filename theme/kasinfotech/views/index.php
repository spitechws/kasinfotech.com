...
<section class="banner-sc">
    ...
    <div class="tablo">
        <div class="tablo--1-ve-2 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="bosluk333"></div>
            <div class="row">
                <div class="col-sm-6 " data-wow-delay="0.8s">
...
<section class="analysis-section">
    ...
    <div class="tabloozellik">
        ...
        <div class="tablo--1-ve-3">
            <div class="paketler " data-wow-delay="0.7s" onclick="location.href='#';" style="cursor:pointer;">
        ...
        <div class="tablo--1-ve-3">
            <div class="paketler " data-wow-delay="0.8s" onclick="location.href='#';" style="cursor:pointer;">
                <div class="analiz-alani">
                    <div class="inner-box">
                        <div class="icon-box">
...
<?php require_once('home-posts.php'); ?>
