            ...
            <div class="col-sm-12 d-flex justify-content-center">
                <span>
                    <a href="javascript:void(0)" class="notification-close-cross" onclick="if (!window.__cfRLUnblockHandlers) return false; hideCookieNote()" data-cf-modified-591e8dac46237a91d428b1a4->
                        <i class="icon icon-Close-Window fa fa-times f-4"></i></a>We use <a href="https://www.kasinfotech.com/privacy-policy#cookies-privacy">cookies</a> to ensure that we give you the best experience on our website. If you're unsure about it, take a look at our <a href="https://www.kasinfotech.com/privacy-policy">privacy policy</a>.
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="sidebar_left_outer d-none d-md-flex">
            ...
            <div class="bg-graylight">
                <ul class="social-icon-main flex-wrap ml-auto d-inline-flex ">
                    ...
                    <li class="social-item">
                        <a href="https://www.youtube.com/user/kasinfotech" class="social-link" target="_blank">
                            <svg viewBox="0 0 100 100" class="svg-icon">
                    ...
                    <li class="social-item">
                        <a href="https://www.instagram.com/kasinfotech/" class="social-link" target="_blank">
                            <svg viewBox="0 0 100 100" class="svg-icon">
                    ...
                    <li class="social-item">
                        <a href="https://dribbble.com/kasinfotech" class="social-link" target="_blank">
                            <svg viewBox="0 0 100 100" class="svg-icon">
