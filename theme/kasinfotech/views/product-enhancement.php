...
<section class="header-spacing awards__banner section-padding pt-0">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="bg-fix banner-holder" style="background-image: url(&quot;<?php echo base_url();?>main-boot-5/images/product-enhancement/banner.png&quot;);">
                    <figure class="banner-holder-img">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/banner.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/banner.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/banner.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/banner.png" alt="Product Enhancement Services" title="Product Enhancement Services" data-pagespeed-url-hash="3738924967" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </figure>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6 row m-0 gy-4 resp-btn-outer">
                <div class="service-box bg-white m-0">
                    <div class="row">
                        <div class="col-lg-2">
                            <picture>
                                <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-1.webp" type="image/webp">
                                <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-1.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-1.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-1.png" alt="Software Enhancements" title="Software Enhancements" class="" data-pagespeed-url-hash="65480700" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                            </picture>
                        </div>
                ...
                <div class="service-box bg-white">
                    <div class="row">
                        <div class="col-lg-2">
                            <picture>
                                <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-2.webp" type="image/webp">
                                <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-2.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-2.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-2.png" alt="Application performance Optimization" title="Application performance Optimization" class="" data-pagespeed-url-hash="359980621" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                            </picture>
                        </div>
                        <div class="col-lg-10 mt-3 mt-lg-0">
                ...
                <div class="service-box bg-white">
                    <div class="row">
                        <div class="col-lg-2">
                            <picture>
                                <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-3.webp" type="image/webp">
                                <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-3.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-3.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/service-3.png" alt="Bug Fixing" title="Bug Fixing" class="" data-pagespeed-url-hash="654480542" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                            </picture>
                        </div>
                        <div class="col-lg-10 mt-3 mt-lg-0">
...
<section class="abt-team">
    <picture>
        <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services.webp" type="image/webp">
        <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services.png" alt="Our Tailored Product Enhancement Services" title="Our Tailored Product Enhancement Services" class="ob-cover w-auto" data-pagespeed-url-hash="296411262" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
    </picture>
    <div class="container">
        <div class="row">
            <div class="col-12">
    ...
    <div class="container">
        ...
        <div class="row gy-4 gy-lg-0">
            <div class="col-lg-6 text-center">
                <picture>
                    <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services-2.webp" type="image/webp">
                    <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services-2.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services-2.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/enhancement-services-2.png" alt="Our Enhancement Experts" title="Our Enhancement Experts" class="" data-pagespeed-url-hash="324769951" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </picture>
            </div>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-1.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-1.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-1.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-1.png" alt="Medical" title="Medical" class="" data-pagespeed-url-hash="2925730850" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-2.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-2.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-2.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-2.png" alt="Education" title="Education" class="" data-pagespeed-url-hash="3220230771" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-3.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-3.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-3.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-3.png" alt="Business" title="Business" class="" data-pagespeed-url-hash="3514730692" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-4.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-4.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-4.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-4.png" alt="Finance" title="Finance" class="" data-pagespeed-url-hash="3809230613" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-5.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-5.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-5.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-5.png" alt="Lifestyle" title="Lifestyle" class="" data-pagespeed-url-hash="4103730534" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-6.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-6.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-6.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-6.png" alt="Food &amp; Drink" title="Food &amp; Drink" class="" data-pagespeed-url-hash="103263159" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-7.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-7.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-7.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-7.png" alt="Shopping" title="Shopping" class="" data-pagespeed-url-hash="397763080" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-8.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-8.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-8.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-8.png" alt="Music" title="Music" class="" data-pagespeed-url-hash="692263001" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-9.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-9.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-9.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-9.png" alt="Travel" title="Travel" class="" data-pagespeed-url-hash="986762922" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-10.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-10.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-10.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-10.png" alt="News" title="News" class="" data-pagespeed-url-hash="1459313184" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-11.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-11.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-11.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-11.png" alt="Photo &amp; Video" title="Photo &amp; Video" class="" data-pagespeed-url-hash="1753813105" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-12.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-12.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-12.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-12.png" alt="Entertainment" title="Entertainment" class="" data-pagespeed-url-hash="2048313026" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-13.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-13.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-13.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-13.png" alt="Social Networking" title="Social Networking" class="" data-pagespeed-url-hash="2342812947" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-14.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-14.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-14.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-14.png" alt="Health &amp; Fitness" title="Health &amp; Fitness" class="" data-pagespeed-url-hash="2637312868" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-15.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-15.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-15.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-15.png" alt="Sports" title="Sports" class="" data-pagespeed-url-hash="2931812789" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-16.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-16.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-16.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-16.png" alt="Weather" title="Weather" class="" data-pagespeed-url-hash="3226312710" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-17.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-17.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-17.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-17.png" alt="Logistic" title="Logistic" class="" data-pagespeed-url-hash="3520812631" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                <div class="service-box px-2">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-18.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-18.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-18.png" src="<?php echo base_url();?>main-boot-5/images/product-enhancement/serve-18.png" alt="Agritech" title="Agritech" class="" data-pagespeed-url-hash="3815312552" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
