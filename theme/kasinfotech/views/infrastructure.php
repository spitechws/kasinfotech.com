...
<section class="home-section hero-banner content-center banner-post header-spacing-padding">
    <figure class="banner-post-img">
        <picture>
            ...
            <img data-src="<?php echo asset(); ?>images/infrastructure/xbanner.jpg.pagespeed.ic.6a7Wy0iqWs.webp" src="<?php echo asset(); ?>images/infrastructure/xbanner.jpg.pagespeed.ic.6a7Wy0iqWs.webp" alt="INFRASTRUCTURE @ kasinfotech" title="INFRASTRUCTURE @ kasinfotech" data-pagespeed-url-hash="3627330988" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />
        </picture>
    </figure>
    <div class="container">
        <div class="text-center">
            ...
            <div class="home-section-title-block">
                <h1 class="home-section-title text-white h1 text-uppercase font-weight-bold ls-lg"><span class="font-weight-light d-block">Infrastructure</span> @ kasinfotech</h1>
            </div>
        </div>
    </div>
</section>
                                    ...
                                    <div id="wistia_grid_29_main" style="width: 1296px; left: 0px; height: 729px; margin-top: 0px;">
                                        ...
                                        <div id="wistia_grid_29_center" style="width: 100%; height: 100%;">
                                            <div class="w-video-wrapper w-css-reset" style="height: 100%; position: absolute; top: 0px; width: 100%; opacity: 1; background-color: rgb(0, 0, 0);">
                                                <video id="wistia_simple_video_62" crossorigin="anonymous" poster="https://fast.wistia.com/assets/images/blank.gif" aria-label="Video" src="blob:https://www.kasinfotech.com/b3386446-58a2-45aa-80dd-8f094e85fedb" controlslist="nodownload" playsinline="" preload="metadata" type="video/m3u8" x-webkit-airplay="allow" style="background: transparent; display: block; height: 100%; max-height: none; max-width: none; position: static; visibility: visible; width: 100%; object-fit: contain;"></video>
                                            </div>
