        ...
        <div class="row remote-agile-box-row">
            <div class="col-lg-4 col-md-6" data-hover=".remote-agile-bg" data-src="images/home/cult-1.jpg?v-1" data-last=".remote-agile-bg-last" data-interact="">
                <div class="remote-agile-box pr-lg-4 border-0">
                    ...
                    <p class="text-secondary text-md desc-item margin-bottom small-heading" style="height: 115.188px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="remote-agile-box pr-lg-4 mb-0" data-hover=".remote-agile-bg" data-src="images/home/cult-2.jpg?v-1" data-last=".remote-agile-bg-last" data-interact="">
                    ...
                    <p class="text-secondary text-md desc-item mb-0 small-heading" style="height: 115.188px;">
            ...
            <div class="col-md-3 col-sm-4 col-6">
                <div class="service-box text-center">
                    ...
                    <h3 class="text-xxl font-semibold small-heading" style="height: 60px;">
                        Proven Development <br class="d-none d-xxl-block" />
                        Records
                    </h3>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="boxed text-center">
                    ...
                    <h2 class="h1 font-semibold text-desc">We are a mixed group of like-minded professionals who firmly believe in leading rather than following</h2>
                                    ...
                                    <div id="wistia_grid_29_main" style="width: 1296px; left: 0px; height: 729px; margin-top: 0px;">
                                        ...
                                        <div id="wistia_grid_29_center" style="width: 100%; height: 100%;">
                                            <div class="w-video-wrapper w-css-reset" style="height: 100%; position: absolute; top: 0px; width: 100%; opacity: 1; background-color: rgb(0, 0, 0);">
                                                <video
                                                    id="wistia_simple_video_77"
                                                    crossorigin="anonymous"
                                                    poster="https://fast.wistia.com/assets/images/blank.gif"
                                                    aria-label="Video"
                                                    src="blob:https://www.bacancytechnology.com/1b53ed4a-c7c6-407c-9a6a-97b0b6a8a215"
        ...
        <div class="row">
            <div class="col-12">
                ...
                <iframe
                    ...
                    height="700"
                    frameborder="0"
                    style="border: 0; max-height: 80vh;"
                    allowfullscreen=""
                ></iframe>
            </div>
        </div>
            ...
            <div class="col-12 mb-lg">
                <div class="section-title-and-desc m-0">
                    <div class="section-title-block">
                        ...
                        <p class="awards__banner-subtitle h3 pb-0">Bacancyers believes that bringing real results and making outsourcing experience successful is a perfect way to get through the heart of customers.</p>
