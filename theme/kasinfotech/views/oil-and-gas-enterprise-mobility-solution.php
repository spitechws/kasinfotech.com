...
<section class="header-spacing banner-main banner-post">
    <figure class="banner-post-img">
        <picture>
            <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/banner.webp" type="image/webp" />
            <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/banner.jpg?v-1" type="image/jpeg" />
            <img
                data-src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/banner.jpg?v-1"
                src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/banner.jpg?v-1"
            ...
            <div class="col-lg-7 col-xl-6">
                <div class="section-title-and-desc">
                    <div class="section-title-block">
                        <h1 class="section-title-text h1-xl lh-normal">Oil and Gas Enterprise Mobility Solution</h1>
                        <p class="text-xxl">Reshape your energy landscape and gain better control by harnessing the best technology solutions into production, sales, distribution and trading operations.</p>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div class="section-title-and-desc section-title-and-desc-two">
                    <div class="section-title-block">
                        <h2 class="section-title-text h1">Building Integrated Mobile Solutions and Technology - Driven Services for Oil &amp; Gas Industry</h2>
                    </div>
                </div>
                <p>
        ...
        <div class="row justify-content-between">
            <div class="col-md-5">
                <div class="section-title-and-desc side-sticky-section">
                    <div class="section-title-block">
                        <h2 class="section-title-text h1">Our Oil &amp; Gas IT Services</h2>
                        <div class="resp-btn">
                ...
                <div class="row gy-4">
                    <div class="col-12">
                        <div class="service-box bg-white">
                            <h3 class="h5 font-bold mb-sm">Oil and Gas Business Consulting Services</h3>
                            <p>
                                Being one of the renowned oil and gas service providers, we incorporate our global approaches as well as experiences to assist clients to respond to the technical changes and unlock the efficient ways to
                                transform their outlook of productivity as well as workforce management.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="service-box bg-white">
                            <h3 class="h5 font-bold mb-sm">Mobility Solutions</h3>
                            <p>
                                We have years of hands-on experience in building world-class mobile applications, whether it is native, hybrid or cross-platform mobile app, we make sure that the oil &amp; gas mobility solution is the most
                                prudent solution and best suited for your business.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="service-box bg-white">
                            ...
                            <p>
                                We let our oil and gas companies to leverage our data analytics proficiencies to manage their distribution networks, digital oil fields, plant operations and infrastructure assets with real-time visibility
                    ...
                    <div class="col-12">
                        <div class="service-box bg-white">
                            <h3 class="h5 font-bold mb-sm">Cloud Managed Services</h3>
                            <p>
                                Our Managed IT services for oil &amp; gas enterprise mobile app solution includes data protection, data recovery and data backup. The cloud managed services delivered by us is sure-shot path to prosperity for
                                sharing the sensitive files amongst stakeholders.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="service-box bg-white">
                            <h3 class="h5 font-bold mb-sm">ERP/CRM Solutions</h3>
                            <p>
                                Our IT experts deliver high-octane ERP and CRM solutions to provide the most optimum platform for all the operations of the oil &amp; gas companies and assist them in demand inventory, forecasting and supply
                                chain management.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="service-box bg-white">
                            <h3 class="h5 font-bold mb-sm">Internet of Things (IoT)</h3>
                            <p>We can help you harness the power of future technology by improving your business productivity and efficiency using our high-end IOT professional services.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section-padding banner-post full-width-form pb-200" id="form">
    <figure class="banner-post-img">
        <picture>
            <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/form-bg.webp" type="image/webp" />
            <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/form-bg.jpg" type="image/jpeg" />
            <img
                data-src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/form-bg.jpg"
                src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/form-bg.jpg"
    ...
    <div class="container">
        ...
        <div class="row align-items-lg-center">
            <div class="col-lg-8 mx-auto text-center">
                <div class="section-title-and-desc">
                    <div class="section-title-block">
                        <h2 class="section-title-text h1 text-white">Leverage Our Oil and Gas Enterprise Mobility Solutions</h2>
                    </div>
                </div>
            </div>
            <div class="col-12">
...
<section class="section-padding-md section-paragraph pb-0">
    <div class="container">
        <div class="row gy-4 align-items-lg-center flex-lg-row-reverse">
            <div class="col-lg-6">
                <picture>
                    <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-2.webp" type="image/webp" />
                    <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-2.jpg" type="image/jpeg" />
                    <img
                        data-src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-2.jpg"
                        src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-2.jpg"
            ...
            <div class="col-lg-6">
                <div class="section-title-and-desc section-title-and-desc-two">
                    <div class="section-title-block">
                        <h2 class="section-title-text h1">Our Competency In The Oil &amp; Gas Industry</h2>
                    </div>
                </div>
                <ul class="text-18 text-secondary style-check">
                    ...
                    <li>
                        Monitoring and tracking system for day to day operations, report generation and dashboard implementation
                    </li>
                    <li>
                        Quality management systems
                    </li>
                    <li>
                        Manufacturing execution systemss
                    </li>
                    <li>
                        Manufacturing Intelligence Integration services
                    </li>
                    <li>
...
<section class="section-padding-md section-paragraph pt-lg-0">
    <div class="container">
        <div class="row gy-4 align-items-lg-center">
            <div class="col-lg-6">
                <picture>
                    <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-1.webp" type="image/webp" />
                    <source srcset="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-1.jpg" type="image/jpeg" />
                    <img
                        data-src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-1.jpg"
                        src="<?php echo base_url(); ?>main-boot-5/images/oil-gas/side-img-1.jpg"
            ...
            <div class="col-lg-6">
                <div class="section-title-and-desc section-title-and-desc-two mt-lg-4">
                    <div class="section-title-block">
                        <h2 class="section-title-text h1">Why You Should Develop Your Oil And Gas Industry Enterprise Mobile Application Solution With Us?</h2>
                    </div>
                </div>
                <ul class="text-18 text-secondary style-check">
                    <li>
                        Developed under the supervision and guidance of industry experts
                    </li>
                    <li>
                        Smarter Utility solutions following the trends of international oil business
                    </li>
                    <li>
                        Reduce the risk associated with financial reporting fraud
                    </li>
                    <li>
                        Identify governance, risk management and compliance information
                    </li>
                    <li>
                        Improve operational efficiency and enhance your business productivity by keeping threats at bay
                    </li>
                    <li>
                        Access app data from anywhere with cloud integration
                    </li>
                </ul>
            </div>
        </div>
