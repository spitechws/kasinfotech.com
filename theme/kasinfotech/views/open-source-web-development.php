        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title-and-desc m-0 section-padding">
                    <div class="section-title-block">
                        <h1 class="section-title-text h1-xl m-0">Open Source Web Development</h1>
                        <p class="awards__banner-subtitle h3">Expert in all kind of open source CMS solutions</p>
                        <a href="#form" class="btn btn-primary text-uppercase ls-xs">schedule a developer interview</a>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="bg-fix banner-holder" style="background-image: url(&quot;https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/xbanner.png.pagespeed.ic.krP_TG79j2.webp&quot;);">
                    <figure class="banner-holder-img">
                        <picture>
                            <source srcset="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/banner.webp" type="image/webp">
                            <source srcset="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/banner.png" type="image/png"><img data-src="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/xbanner.png.pagespeed.ic.krP_TG79j2.webp" src="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/xbanner.png.pagespeed.ic.krP_TG79j2.webp" alt="Open Source Web Development" title="Open Source Web Development" data-pagespeed-url-hash="3507575202" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </figure>
                </div>
            </div>
            ...
            <div class="col-lg-10 mx-auto">
                <div class="row">
                    <div class="col-lg-5 col-md-5">
                        <h2 class="font-bold h3">Why Should We Opt For Open Source Development?</h2>
                    </div>
                    <div class="col-lg-6 col-md-7 ml-auto mt-3 mt-md-0">
                        <ul class="style-check style-check-black text-18 text-secondary small-heading-two" style="height: 214px;">
                            <li>User friendly</li>
                            <li>Saves time and money of business at great extent</li>
                            <li>Enables to develop the source code</li>
                            <li>Minimum cost and maximum time benefits</li>
                            <li>Meets all the needs of your business</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control bg-graylight validate-required focus-class" id="focus-id" maxlength="80" name="contactName" size="20" placeholder="Your Name" fdprocessedid="mwkrcf" style="outline: rgb(149, 143, 143) solid 2px;">
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control bg-graylight validate-required" placeholder="Email Address" id="email" maxlength="80" name="contactEmail" size="20" fdprocessedid="fgq9dx">
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <input type="number" class="form-control bg-graylight validate-required" placeholder="Phone Number" id="phone" maxlength="40" name="contactPhone" size="20" nkeypress="return isNumberKey(event)" fdprocessedid="turzgj">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12 text-center">
                                    <button class="btn btn-primary text-uppercase ls-xs" name="contactBtn" fdprocessedid="s5agop">inquire
                                        now</button>
                                </div>
                            </div>
...
<section class="abt-team">
    <figure>
        <picture>
            <source srcset="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/bg-development-partner.webp" type="image/webp">
            <source srcset="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/bg-development-partner.png" type="image/png"><img data-src="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/xbg-development-partner.png.pagespeed.ic.qbW_g8B1sj.webp" src="https://www.bacancytechnology.com/main-boot-5/images/open-source-web-development/xbg-development-partner.png.pagespeed.ic.qbW_g8B1sj.webp" alt="Why Bacancy?" title="Why Bacancy?" class="ob-cover w-auto" data-pagespeed-url-hash="1702288560" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
        </picture>
    </figure>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="boxed ">
                    ...
                    <ul class="style-check style-check-black text-18 text-secondary">
                        <li>Highly qualified and team of experts, developing custom application by the use of open source technology</li>
                        <li>Satisfying solutions for customer’s smallest requirement</li>
                        <li>A leader in providing open source development</li>
                        <li>Experience of creating high quality applications</li>
                        <li>Helps you to reach at your target audience and clients</li>
                        <li>Our constant service and counseling for clients to enable them to deal with latest changes in open source technology</li>
                        <li>Depth understanding of open source related technologies</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="insight-slider-wrapper section-padding pb-0 section-paragraph">
            ...
            <div class="insight-slider-main section-padding-md ">
                <div class="owl-carousel owl-nav-top-right owl-loaded owl-drag" id="insight-owl-carousel" data-sync="#insight-navigation-block">
                    ...
                    <div class="owl-nav"><button type="button" role="presentation" class="owl-prev disabled" fdprocessedid="ds2jon"><span class="long-arrow-hover"><span class="long-arrow-icon-css icon-item icon-left"></span></span></button><button type="button" role="presentation" class="owl-next" fdprocessedid="qoyaa3"><span class="long-arrow-hover"><span class="long-arrow-icon-css icon-item"></span></span></button></div>
                    <div class="owl-dots disabled"><button role="button" class="owl-dot active" fdprocessedid="kr3n3g"><span></span></button><button role="button" class="owl-dot" fdprocessedid="zdfygs"><span></span></button><button role="button" class="owl-dot" fdprocessedid="fvk2fj"><span></span></button></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-9">
                    <div class="m-0">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <input type="text" class="form-control validate-required" name="contactName" placeholder="Full Name" fdprocessedid="ssgjvn">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <input type="text" class="form-control validate-required" placeholder="Email" name="contactEmail" fdprocessedid="2xbzzq">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <input type="text" class="form-control validate-required" placeholder="Phone Number" name="contactPhone" nkeypress="return isNumberKey(event)" fdprocessedid="iwvf">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-12 text-right">
                                <button class="btn btn-outline-primary text-uppercase ls-xs" name="contactBtn" fdprocessedid="wyq42l">inquire now</button>
                            </div>
                        </div>
                    </div>
                </div>
