...
<section class="header-spacing awards__banner section-padding pt-0">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="bg-fix banner-holder" style="background-image: url(&quot;<?php echo base_url();?>main-boot-5/images/open-source-web-development/xbanner.png.pagespeed.ic.krP_TG79j2.webp&quot;);">
                    <figure class="banner-holder-img">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/open-source-web-development/banner.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/open-source-web-development/banner.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/open-source-web-development/xbanner.png.pagespeed.ic.krP_TG79j2.webp" src="<?php echo base_url();?>main-boot-5/images/open-source-web-development/xbanner.png.pagespeed.ic.krP_TG79j2.webp" alt="Open Source Web Development" title="Open Source Web Development" data-pagespeed-url-hash="3507575202" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </figure>
                </div>
            </div>
