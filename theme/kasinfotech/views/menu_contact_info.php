    ...
    <div class="row g-4 gy-lg-0">
        <div class="col-lg-3">
            <div class="get-in-touch-block">
                ...
                <div class="right-content">
                    ...
                    <a class="h6" href="mailto:<?php echo $contact_email; ?>"><span><?php echo $contact_email; ?></span></a>
                </div>
            </div>
        </div>
        <div class="col-md-7 col-lg-3">
            <div class="get-in-touch-block">
                ...
                <div class="right-content">
                    <p class="text-secondary text-md">CALL</p>
                    <h4 class="h6 ">
                        <a href="tel:<?php echo $contact_number; ?>" class><?php echo $contact_number; ?></a>
                    </h4>
                </div>
            </div>
        </div>
        <div class="col-md-7 col-lg-3">
            <div class="get-in-touch-block">
                ...
                <div class="right-content">
                    <p class="text-secondary text-md">WhatsApp</p>
                    <h4 class="h6 ">
                        <a href="tel:<?php echo $whatsapp; ?>" class><?php echo $whatsapp; ?></a>
                    </h4>
                </div>
            </div>
        </div>
