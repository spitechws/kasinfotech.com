...
<section class="header-spacing awards__banner section-padding-md pt-0">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="bg-fix banner-holder" style="background-image: url(&quot;<?php echo base_url();?>main-boot-5/images/digitalworkplace/digitalworkplace.png&quot;);">
                    <figure class="banner-holder-img">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/digitalworkplace.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/digitalworkplace.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/digitalworkplace.png" src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/digitalworkplace.png" alt="Digital Workplace Services" title="Digital Workplace Services" data-pagespeed-url-hash="2976744047" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </figure>
                </div>
            </div>
        ...
        <div class="row gy-4 justify-content-center service-box-row service-box-row-without-cursor">
            <div class="col-md-6 col-lg-4">
                <div class="service-box active  bg-white">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Consultants.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Consultants.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Consultants.png" src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Consultants.png" alt="Startup Consulting" title="Startup Consulting" class="svg-icon m-0" data-pagespeed-url-hash="4060059249" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="service-box active  bg-white">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Transforming.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Transforming.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Transforming.png" src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/Transforming.png" alt="Transforming Businesses" title="Transforming Businesses" class="svg-icon m-0" data-pagespeed-url-hash="4013610567" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="service-box active  bg-white">
                    <div class="svg-icon-box">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/ManagedIT.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digitalworkplace/ManagedIT.png" type="image/png"><img data-src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/ManagedIT.png" src="<?php echo base_url();?>main-boot-5/images/digitalworkplace/ManagedIT.png" alt="Managed IT Services" title="Managed IT Services" class="svg-icon m-0" data-pagespeed-url-hash="4215488775" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </div>
