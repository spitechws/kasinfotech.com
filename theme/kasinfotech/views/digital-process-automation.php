...
<section class="header-spacing awards__banner section-padding-md pt-0">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="bg-fix banner-holder" style="background-image: url(&quot;<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/banner.jpg&quot;);">
                    <figure class="banner-holder-img">
                        <picture>
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/banner.webp" type="image/webp">
                            <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/banner.jpg" type="image/jpeg"><img data-src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/banner.jpg" src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/banner.jpg" alt="Digital Process Automation Services" title="Digital Process Automation Services" class="" data-pagespeed-url-hash="1188856916" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                        </picture>
                    </figure>
                </div>
            </div>
        ...
        <div class="row gy-4 justify-content-center service-box-row service-box-row-without-cursor">
            <div class="col-lg-4 col-md-6">
                <div class="service-box active p-0">
                    <picture>
                        <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-1.webp" type="image/webp">
                        <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-1.jpg" type="image/jpeg"><img data-src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-1.jpg" src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-1.jpg" alt="Automation in Robotic Processes" title="Automation in Robotic Processes" class="w-100" data-pagespeed-url-hash="3129131629" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    </picture>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-box active p-0">
                    <picture>
                        <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-2.webp" type="image/webp">
                        <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-2.jpg" type="image/jpeg"><img data-src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-2.jpg" src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-2.jpg" alt="Automation of remotely located desktops" title="Automation of remotely located desktops" class="w-100" data-pagespeed-url-hash="3423631550" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    </picture>
                    <div class="mb-0 service-box  bg-white mt-lg-0">
            ...
            <div class="col-lg-4 col-md-6 ">
                <div class="service-box active p-0">
                    <picture>
                        <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-3.webp" type="image/webp">
                        <source srcset="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-3.jpg" type="image/jpeg"><img data-src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-3.jpg" src="<?php echo base_url();?>main-boot-5/images/digital-process-automation-services/servi-3.jpg" alt="Artificial Intelligence" title="Artificial Intelligence" class="w-100" data-pagespeed-url-hash="3718131471" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    </picture>
