                        ...
                        <div class="card custom-card mt-4 mb-3">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered academic-calendar">
                                    ...
                                    <tbody>
                                    <?php if(isset($aSports) && is_array($aSports) && !empty($aSports)) {
                                        foreach($aSports as $row) { ?>
                                    <tr>
                                        <td><?php echo config_date($row->created_date); ?></td>
                                        <td>
                                            <a href="<?php echo media_download_url($row->attachment, 'sports'); ?>"><?php echo $row->title; ?></a>
                                        </td>
                                        <td>
                                            <a href="<?php echo media_download_url($row->attachment, 'sports'); ?>"><i class="far fa-file-pdf"></i></a>
                                        </td>
                                    </tr>
                                <?php } } else { ?>
                                    <tr>
